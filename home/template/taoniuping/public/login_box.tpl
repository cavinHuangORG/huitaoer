...
<div id="dialog_log_qiandao_border" class="dialog-wrapper" style="display:none;top: 50%;left: 50%;margin-left: -157px;margin-top: -176px;">
<div id="dialog_log_qiandao">
...
<div class="dialog-overlay" style="display:none;background-color: rgb(0, 0, 0); width: 100%; height: 100%; opacity: 0.5; position: fixed; overflow: hidden; left: 0px; top: 0px; z-index: 999; background-position: initial initial; background-repeat: initial initial;filter:alpha(opacity=50);"></div>