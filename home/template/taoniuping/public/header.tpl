...
<link href="<?=PATH_TPL;?>/static/css/base.css" type="text/css" rel="stylesheet"/>
<link href="<?=PATH_TPL;?>/static/css/index_page.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript" src="<?=PATH_TPL;?>/static/js/index_js.js"></script>
