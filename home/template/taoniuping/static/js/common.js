$(function(){
	...
	$(".sign_panel").mouseenter(function(){
		$(".sign_panel").addClass("open");
	}).mouseleave(function(){
		$(".sign_panel").removeClass("open");
	})
	//页脚微信
	$("#foot_kik").hover(function(){$(".kit-img").show()},function(){$(".kit-img").hide()})
})
//签到
function sign(json){
	if(json.code==-1){
...
/*登陆框*/
function login_box(){
	$("#dialog_log_qiandao_border").show();
	$(".dialog-overlay").show();
}
function login_box_close(){
	$("#dialog_log_qiandao_border").hide();
	$(".dialog-overlay").hide();
}
function box_login(){
