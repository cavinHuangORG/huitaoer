...
CREATE TABLE pre_goods (
  ...
  `coupon_url`  varchar(255) NOT NULL COMMENT '优惠券链接',
  `mcoupon_url`  varchar(255) NULL COMMENT '手机优惠券链接',  
  `coupon_money`  int(11) NOT NULL COMMENT '优惠券金额',
  `coupon_total`  int(11) NOT NULL COMMENT '优惠券总数',
  `coupon_give`  int(11) NOT NULL COMMENT '优惠券已领数量',
  `qq_url`  varchar(255) NOT NULL COMMENT '鹊桥链接',
  `isturn`  tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否转换',
  ...
  `wid` INT( 10 ) UNSIGNED NOT NULL COMMENT  '值得买主题ID',
  PRIMARY KEY (`id`),
...
---------主题表--------------------------------------------
DROP TABLE IF EXISTS pre_worth;
CREATE TABLE pre_worth (
  `wid` int(10) unsigned NOT NULL,
  `title` varchar(100) NOT NULL COMMENT '标题',
  `descr` varchar(1000) NOT NULL COMMENT '描述',
  `pic` varchar(255) NOT NULL COMMENT '主题图片',
  `like_num` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '收藏数量',
  `share_num` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '转发数量',
...
) ENGINE=MyISAM AUTO_INCREMENT=165 DEFAULT CHARSET=utf8 COMMENT='值得买主题表';
------------------------------------------------------------
DROP TABLE IF EXISTS pre_worth_like;
CREATE TABLE pre_worth_like (
  `id` int(11) NOT NULL,
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
  `wid` int(10) unsigned NOT NULL COMMENT '主题id'
) ENGINE=MyISAM AUTO_INCREMENT=802 DEFAULT CHARSET=utf8 COMMENT='值得买收藏表';
-------------------------------------------------------------
ALTER TABLE `pre_worth`
  ADD PRIMARY KEY (`wid`),
  ADD KEY `start` (`start`);
-------------------------------------------------------------
ALTER TABLE `pre_worth_like`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uid` (`uid`,`wid`);
-------------------------------------------------------------
ALTER TABLE `pre_worth`
  MODIFY `wid` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=165;
-------------------------------------------------------------
ALTER TABLE `pre_worth_like`
