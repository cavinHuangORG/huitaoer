...
function check_install(){
	...
	if(file_exists($lockfile)){
		//show_msg('安装锁定，已经安装过了，如果您确定要重新安装，请到服务器上删除<br /> '.str_replace(PATH_ROOT, '', $lockfile),0);
		install_err('已经安装过了');
		return true;
	}else{
		return false;
...
define('COOKIE_DOMAIN', '{$Seturl}'); //正式环境中如果要考虑二级域名问题的应该用 .xxx.com
define('COOKIE_PATH', '/');
define('URL', '{$url}');
EOT;
...
function dir_clear($dir,$del=false) {
	showjsmessage('清空目录 '.str_replace(PATH_ROOT, '', $dir));
	//先删除目录下的文件：
	$dh=opendir($dir);
...
<div class="container">
	<div class="header">
		<h1>轩宇淘宝客 安装向导</h1>
		<span>轩宇淘宝客</span>
		<span><a href="http://www.yuanmawu.net" target="_blank" style="font-weight: bolder;">代安装服务</a></span>
	</div>
<?php 
}
...
?>
	<div class="footer">©2001 - 2016 <a href="http://www.yuanmawu.net/" target="_blank">成都网悦</a> Inc.&nbsp;<a href="http://www.yuanmawu.net" target="_blank" style="font-weight: bolder;">代安装服务</a></div>
</div>
</body>
</html>
<?php 
