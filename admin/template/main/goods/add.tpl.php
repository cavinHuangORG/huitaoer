...
<form method="post" action="?mod=main&ac=goods&op=add">
    <table class="table-font"><tbody>
        ...
        <tr>
            <th class="w120">鹊桥链接：</th>
            <td><input type="text" class="textinput w270" name="good[qq_url]" value="<?=$good['qq_url'];?>"></td>
        </tr>
        <tr>
            <th class="w120">优惠券链接：</th>
            <td><input type="text" class="textinput w270" name="good[coupon_url]" value="<?=$good['coupon_url'];?>"></td>
        </tr>
        <tr>
            <th class="w120">优惠券金额：</th>
            <td><input type="text" class="textinput w70" name="good[coupon_money]" value="<?=$good['coupon_money'];?>"></td>
        </tr>
        <tr>
            <th>所属频道：</th>
            <td>
