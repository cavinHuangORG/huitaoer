...
<ul class="nav">
	<li <?=$active['set'];?>><a href="?mod=<?=MODNAME;?>&ac=<?=ACTNAME;?>&op=set">举报设置</a></li>
	<li <?=$active['list'];?>><a href="?mod=<?=MODNAME;?>&ac=<?=ACTNAME;?>&op=list">举报处理</a></li>   		         
</ul>
...
<?php }elseif($op=='list'){ ?>
	<div class="table">
		<form method="POST" action="?mod=<?=MODNAME;?>&ac=<?=ACTNAME;?>&op=list">
		<div class="th">
	        宝贝名称/举报原因:
	...
	<form method="POST" action="?mod=public&ac=del">
	<div class="table">
