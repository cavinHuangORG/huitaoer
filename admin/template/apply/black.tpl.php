...
<ul class="nav">
	<li <?=$active['list'];?>><a href="?mod=<?=MODNAME;?>&ac=<?=ACTNAME;?>&op=list">黑名单</a></li>
	<li <?=$active['addblack'];?>><a href="?mod=<?=MODNAME;?>&ac=<?=ACTNAME;?>&op=addblack">添加黑名单</a></li>           
</ul>
...
<?php }elseif ($op=='addblack'){ ?>
	<form method="post" action="?mod=<?=MODNAME;?>&ac=<?=ACTNAME;?>&op=addblack">
