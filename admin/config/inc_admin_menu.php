...
<root>
	<menu name='后台首页' id="1">
		<node name='常用操作' id="1">
	  		...
	  		<item id="6" name='自动采集设置' url='?mod=data&ac=autogather' mod='data' ac='autogather' />
	  		<item id="7" name='一键检测优惠券' url='?mod=data&ac=checkcoupon' mod='data' ac='checkcoupon' />
	  		<item id="8" name='清理缓存' url='?mod=data&ac=clear' mod='data' ac='clear' />
		</node>
	</menu>
	...
	<menu name='网站设置' id="2">
	  <node name='网站设置' id="1">
	    ...
	    <item id="11" name='淘口令设置' url='?mod=seting&ac=tkl' mod='seting' ac='tkl' />
	    <item id="12" name='管理员设置' url='?mod=seting&ac=manager' mod='seting' ac='manager' />
	  </node>
	</menu>
	...
	<menu name='商品管理' id="4"> 
	  ...
	  <node name='兑换管理' id="4">
	   ...
	   <node name='值得买管理' id="7">
	  	 <item id="1" name='主题列表' url='?mod=main&ac=worth&op=worth_list' mod='main' ac='wlist' />
	  	 <item id="2" name='商品列表' url='?mod=main&ac=worth&op=goods_list' mod='main' ac='glist' />	
	  	 <item id="3" name='添加主题' url='?mod=main&ac=worth&op=worth_add' mod='main' ac='worth' />
	   </node>  
	</menu>
